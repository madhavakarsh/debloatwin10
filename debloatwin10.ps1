			...
			$tweaks = @(
				...
				"InstallTitusProgs",      #REQUIRED FOR INSTALLING OTHER PROGRAMS!
				# "InstallSumatraPDF",
				# "Install7Zip",
				...
				# "DisableQuickAccessInExplorer",              # "EnableQuickAccessInExplorer",
			...
			Function InstallSumatraPDF {
				Write-Output "Installing Sumatra PDF Reader"
			...
			Function DisableQuickAccessInExplorer {
				Write-Output "Disabling Quick Access in FIle Explorer..."
				New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" -Name "HubMode" -PropertyType "DWORD" -Value ”1” 
			}
			
			# Enable Quick Access on File Explorer
			Function EnableQuickAccessInExplorer {
				Write-Output "Enabling Quick Access in FIle Explorer..."
				New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer" -Name "HubMode" -PropertyType "DWORD" -Value ”0” 
			}
